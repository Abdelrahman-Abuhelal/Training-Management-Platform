...
public interface TraineeMapper {
    ...
    @Mapping(source = "traineeDataDto.trainingYear",target = "trainingYear")
    @Mapping(source = "traineeDataDto.trainingSeason",target = "trainingSeason")
    @Mapping(source = "traineeDataDto.startTrainingDate",target = "startTrainingDate")
    @Mapping(source = "traineeDataDto.endTrainingDate",target = "endTrainingDate")
